(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
    ["main"], {
        ...
        /***/
        "./sdk/playlist/api/addTrack.service.ts":
        /*!**********************************************!*\
          !*** ./sdk/playlist/api/addTrack.service.ts ***!
          \**********************************************/
        ...
        /***/
            ...
            __webpack_require__.d(__webpack_exports__, "AddTrackService", function() { return AddTrackService; });
            /* harmony import */
            ...
            /* harmony import */
            var _variables__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__( /*! ../variables */ "./sdk/playlist/variables.ts");
            /* harmony import */
            var _configuration__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__( /*! ../configuration */ "./sdk/playlist/configuration.ts");
            /**
             * Playlist Service
            ...
            var AddTrackService = /** @class */ (function() {
                function AddTrackService(httpClient, basePath, configuration) {
                    ...
                    this.basePath = 'http://playlist-dfroehli-opendj-dev.apps.ocp1.stormshift.coe.muc.redhat.com/api/v1';
                 ...
                 */
                AddTrackService.prototype.canConsumeForm = function(consumes) {
                ...
                AddTrackService.prototype.addtrackPost = function(body, observe, reportProgress) {
        ...
        /***/
        "./sdk/playlist/api/playlists.service.ts":
        /*!***********************************************!*\
          !*** ./sdk/playlist/api/playlists.service.ts ***!
          \***********************************************/
        ...
        /***/
            ...
            __webpack_require__.r(__webpack_exports__);
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "PlaylistsService", function() { return PlaylistsService; });
            /* harmony import */
            var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__( /*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */
            var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__( /*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
            ...
            var PlaylistsService = /** @class */ (function() {
                 ...
                 * @return true: consumes contains 'multipart/form-data', false: otherwise
                 */
                PlaylistsService.prototype.canConsumeForm = function(consumes) {
                    var form = 'multipart/form-data';
                    for (var _i = 0, consumes_1 = consumes; _i < consumes_1.length; _i++) {
                        var consume = consumes_1[_i];
                        if (form === consume) {
                ...
                PlaylistsService.prototype.getFirstTrackPlaylistIdGet = function(playlistId, observe, reportProgress) {
                    if (observe === void 0) { observe = 'body'; }
                    if (reportProgress === void 0) { reportProgress = false; }
                ...
                PlaylistsService.prototype.playlistsGet = function(observe, reportProgress) {
                    if (observe === void 0) { observe = 'body'; }
                    if (reportProgress === void 0) { reportProgress = false; }
                    var headers = this.defaultHeaders;
                    // to determine the Accept header
                ...
                PlaylistsService.prototype.playlistsPlaylistIdDelete = function(playlistId, observe, reportProgress) {
                    if (observe === void 0) { observe = 'body'; }
                    if (reportProgress === void 0) { reportProgress = false; }
                    if (playlistId === null || playlistId === undefined) {
                ...
                PlaylistsService.prototype.playlistsPlaylistIdFirstTrackGet = function(playlistId, observe, reportProgress) {
                    if (observe === void 0) { observe = 'body'; }
                    if (reportProgress === void 0) { reportProgress = false; }
                    if (playlistId === null || playlistId === undefined) {
                ...
                PlaylistsService.prototype.playlistsPlaylistIdGet = function(playlistId, observe, reportProgress) {
                    if (observe === void 0) { observe = 'body'; }
                    if (reportProgress === void 0) { reportProgress = false; }
                    if (playlistId === null || playlistId === undefined) {
                ...
                PlaylistsService.prototype.playlistsPlaylistIdPut = function(playlistId, body, observe, reportProgress) {
                    if (observe === void 0) { observe = 'body'; }
                    if (reportProgress === void 0) { reportProgress = false; }
                    if (playlistId === null || playlistId === undefined) {
                ...
                PlaylistsService.prototype.playlistsPlaylistIdTracksResourceURIDelete = function(playlistId, resourceURI, observe, reportProgress) {
                    if (observe === void 0) { observe = 'body'; }
                    if (reportProgress === void 0) { reportProgress = false; }
                    if (playlistId === null || playlistId === undefined) {
                ...
                PlaylistsService.prototype.playlistsPost = function(body, observe, reportProgress) {
                    if (observe === void 0) { observe = 'body'; }
                    if (reportProgress === void 0) { reportProgress = false; }
                    var headers = this.defaultHeaders;
                    // to determine the Accept header
        ...
        /***/
            ...
            __webpack_require__.r(__webpack_exports__);
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "Configuration", function() { return Configuration; });
        ...
        /***/
            ...
            __webpack_require__.r(__webpack_exports__);
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "BASE_PATH", function() { return BASE_PATH; });
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "COLLECTION_FORMATS", function() { return COLLECTION_FORMATS; });
            /* harmony import */
        ...
        /***/
        "./sdk/spotify-provider/api/default.service.ts":
        /*!*****************************************************!*\
          !*** ./sdk/spotify-provider/api/default.service.ts ***!
          \*****************************************************/
        ...
        /***/
            ...
            __webpack_require__.r(__webpack_exports__);
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "DefaultService", function() { return DefaultService; });
            /* harmony import */
            var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__( /*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */
            var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__( /*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
            ...
            var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__( /*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
            /* harmony import */
            var _variables__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__( /*! ../variables */ "./sdk/spotify-provider/variables.ts");
            /* harmony import */
            var _configuration__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__( /*! ../configuration */ "./sdk/spotify-provider/configuration.ts");
            /**
             * title
             * description
             *
            ...
            var DefaultService = /** @class */ (function() {
                ...
                DefaultService.prototype.currentTrackGet = function(observe, reportProgress) {
                    if (observe === void 0) { observe = 'body'; }
                    if (reportProgress === void 0) { reportProgress = false; }
                    var headers = this.defaultHeaders;
                    // to determine the Accept header
                    ...
                    // to determine the Content-Type header
                    var consumes = [];
                    return this.httpClient.get(this.basePath + "/currentTrack", {
                        withCredentials: this.configuration.withCredentials,
                        headers: headers,
                        observe: observe,
                        reportProgress: reportProgress
                ...
                DefaultService.prototype.playPost = function(body, observe, reportProgress) {
                    if (observe === void 0) { observe = 'body'; }
                    if (reportProgress === void 0) { reportProgress = false; }
                    if (body === null || body === undefined) {
                        throw new Error('Required parameter body was null or undefined when calling playPost.');
                    }
                    var headers = this.defaultHeaders;
                    // to determine the Accept header
                    var httpHeaderAccepts = [];
                    ...
                    return this.httpClient.post(this.basePath + "/play", {
                        withCredentials: this.configuration.withCredentials,
                        headers: headers,
                        observe: observe,
                        reportProgress: reportProgress
        ...
        /***/
        "./sdk/spotify-provider/configuration.ts":
        /*!***********************************************!*\
          !*** ./sdk/spotify-provider/configuration.ts ***!
          \***********************************************/
        /*! exports provided: Configuration */
        ...
        /***/
        "./sdk/spotify-provider/variables.ts":
        /*!*******************************************!*\
          !*** ./sdk/spotify-provider/variables.ts ***!
          \*******************************************/
        /*! exports provided: BASE_PATH, COLLECTION_FORMATS */
        ...
        /***/
            ...
            var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__( /*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
            /* harmony import */
            var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__( /*! @angular/platform-browser */ "./node_modules/@angular/platform-browser/fesm5/platform-browser.js");
            /* harmony import */
            ...
            /* harmony import */
            var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__( /*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
            /* harmony import */
            ...
            /* harmony import */
            var _sdk_playlist_api_playlists_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__( /*! ../../sdk/playlist/api/playlists.service */ "./sdk/playlist/api/playlists.service.ts");
            /* harmony import */
            var _sdk_playlist_api_addTrack_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__( /*! ../../sdk/playlist/api/addTrack.service */ "./sdk/playlist/api/addTrack.service.ts");
            /* harmony import */
            var _sdk_spotify_provider_api_default_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__( /*! ../../sdk/spotify-provider/api/default.service */ "./sdk/spotify-provider/api/default.service.ts");
                ...
                AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
                        ...
                        providers: [
                            ...
                            _sdk_playlist_api_playlists_service__WEBPACK_IMPORTED_MODULE_10__["PlaylistsService"],
                            _sdk_playlist_api_addTrack_service__WEBPACK_IMPORTED_MODULE_11__["AddTrackService"],
                            _sdk_spotify_provider_api_default_service__WEBPACK_IMPORTED_MODULE_12__["DefaultService"],
        ...
        /***/
            ...
            module.exports = __webpack_require__( /*! /Users/columbennett/work/OpenDJ/frontend/app/src/main.ts */ "./src/main.ts");
