...
export class PlaylistsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public playlistsPlaylistIdDelete(playlistId: string, observe?: 'body', reportProgress?: boolean): Observable<Playlist>;
    public playlistsPlaylistIdDelete(playlistId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Playlist>>;
    public playlistsPlaylistIdDelete(playlistId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Playlist>>;
